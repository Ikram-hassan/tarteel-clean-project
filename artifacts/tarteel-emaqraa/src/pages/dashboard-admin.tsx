        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  {applications.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {applications.map((app, i) => (
                        <div
                          key={i}
                          className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-secondary/50 rounded-lg border gap-3"
                        >
                          ...
                          <div className="flex gap-2 shrink-0">
                            <Button
                              ...
                              data-testid={`button-reject-teacher-${i}`}
                            >
                              <XCircle
                                size={14}
                            ...
                            <Button
                              size="sm"
                              className="bg-tarteel-maroon hover:bg-tarteel-maroon/90 text-white"
                              onClick={() => handleApprove(app.name)}
                              data-testid={`button-approve-teacher-${i}`}
                            >
            ...
            <motion.div variants={item}>
              <Card className="shadow-md h-full">
                <CardHeader className="pb-2">
                  <CardTitle className="text-tarteel-maroon text-base">
                    Quick Actions
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  <Dialog open={certOpen} onOpenChange={setCertOpen}>
                    <DialogTrigger asChild>
                      <Button
                        className="w-full bg-[#E07B39] hover:bg-[#E07B39]/90 text-white justify-start"
                    ...
                    <DialogContent className="sm:max-w-md">
                      <DialogHeader>
                        <DialogTitle className="text-tarteel-maroon font-serif">
                      ...
                      >
                        ...
                        <Button
                          type="submit"
                          className="w-full bg-tarteel-maroon hover:bg-tarteel-maroon/90 text-white"
                          data-testid="button-issue-cert-submit"
                        >
                          Issue Certificate
                        </Button>
                      </form>
                  ...
                  <Button
                    asChild
                    className="w-full bg-tarteel-maroon hover:bg-tarteel-maroon/90 text-white justify-start"
                  >
                  ...
                  >
                    <Link href="/live-class">
                      <PlayCircle size={16} className="mr-2" /> Monitor Live
                      Class
                    </Link>
                  </Button>
                </CardContent>
                      ...
                      {filteredStudents.map((s, i) => (
                        ...
                        >
                          ...
                          <td className="py-3">
                            <Badge
                              variant="outline"
                              className="text-xs border-tarteel-maroon/30 text-tarteel-maroon"
                            >
                              {s.level}
                            </Badge>
                          </td>
                          ...
                          <td
                            className={`py-3 font-bold text-sm ${s.status === "warning" ? "text-red-500" : "text-green-600"}`}
                          >
                            {s.attendance}
                          </td>
                          <td className="py-3">
                          ...
                          <td className="py-3">
                            <Button
                              size="sm"
                              variant="ghost"
                              className="h-7 text-xs text-tarteel-maroon hover:bg-tarteel-maroon/10"
                            >
                              View
                            </Button>
                          </td>
